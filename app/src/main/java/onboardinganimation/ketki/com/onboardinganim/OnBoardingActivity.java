...
public class OnBoardingActivity extends Activity {
  ...
  private Integer[] boardingImages = new Integer[]{
  ...
  private final int ANIMATION_INTERVAL = 2800;
  ...
  private void startAnimation() {
    ...
    }, INITIAL_DELAY + ANIMATION_INTERVAL / 2, ANIMATION_INTERVAL);
  }
  ...
  public synchronized void createRightAnimator() {
    ...
    if (count == 1) {
      ...
      ml1.animate()
          ...
          .x(-100f)
          .setDuration(ANIMATION_INTERVAL - 200)
          .setInterpolator(new AccelerateDecelerateInterpolator());
    }
  }
